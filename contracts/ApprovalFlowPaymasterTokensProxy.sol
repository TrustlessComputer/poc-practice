...
contract ApprovalFlowPaymasterTokensUpgradeable is IPaymaster, OwnableUpgradeable {
    ...
    function initialize(address[] memory tokens, uint128[] memory gasPrices) public initializer {
